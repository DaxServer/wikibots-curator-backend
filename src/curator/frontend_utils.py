...
def setup_frontend_assets():
    api_url = f"https://api.github.com/repos/DaxServer/wikibots-curator-frontend/releases/latest"
    try:
    ...
    if not asset_download_url:
        print(f"Error: Asset 'dist.tar.gz' not found in the latest release.")
        sys.exit(1)
