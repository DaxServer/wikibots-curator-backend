...
class GlobeCoordinateDataValue(BaseModel):
    type: Literal["globecoordinate"] = Field(default="globecoordinate", frozen=True)
    value: DataValueGlobeCoordinate = Field(
        description="""Data value globe coordinate"""
    )
    ...
    def unwrap_additional_properties(cls, data):
        ...
        known_object_properties = ["type", "value", "additional_properties"]
        ...
        known_json_properties = ["type", "value", "additionalProperties"]
