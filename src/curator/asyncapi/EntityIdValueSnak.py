...
class EntityIdValueSnak(BaseModel):
    snaktype: Literal["value"] = Field(default="value", frozen=True)
    property: str = Field(description="""Property ID""")
    datatype: Literal["wikibase-item"] = Field(default="wikibase-item", frozen=True)
    datavalue: EntityIdDataValue = Field(description="""Entity ID data value""")
