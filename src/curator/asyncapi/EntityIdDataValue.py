...
class EntityIdDataValue(BaseModel):
    type: Literal["wikibase-entityid"] = Field(default="wikibase-entityid", frozen=True)
    value: DataValueEntityId = Field(description="""Data value entity ID""")
