...
class DataValueEntityId(BaseModel):
    entity_type: WikibaseEntityType = Field(
        description="""Wikibase entity type""", alias="""entity-type"""
    )
    numeric_id: int = Field(description="""Numeric ID""", alias="""numeric-id""")
    ...
    def unwrap_additional_properties(cls, data):
        ...
        known_object_properties = ["entity_type", "numeric_id", "additional_properties"]
        ...
        known_json_properties = ["entity-type", "numeric-id", "additionalProperties"]
