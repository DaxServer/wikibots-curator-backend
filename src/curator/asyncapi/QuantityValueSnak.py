...
class QuantityValueSnak(BaseModel):
    snaktype: Literal["value"] = Field(default="value", frozen=True)
    property: str = Field(description="""Property ID""")
    datatype: Literal["quantity"] = Field(default="quantity", frozen=True)
    datavalue: QuantityDataValue = Field(description="""Quantity data value""")
