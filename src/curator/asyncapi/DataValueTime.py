...
class DataValueTime(BaseModel):
    time: str = Field(description="""Time""")
    timezone: Optional[int] = Field(description="""Timezone""", default=None)
    before: Optional[int] = Field(description="""Before""", default=None)
    after: Optional[int] = Field(description="""After""", default=None)
    precision: Optional[int] = Field(description="""Precision""", default=None)
    calendarmodel: Optional[str] = Field(description="""Calendar model""", default=None)
