...
class Statement(BaseModel):
    ...
    rank: Rank = Field(description="""Rank""")
    qualifiers: dict[
        str,
        List[
            Union[
    ...
    ] = Field(description="""Claims""", default={})
    ...
    @field_validator("qualifiers", "additional_properties", mode="before")
    @classmethod
    ...
    @field_validator("qualifiers_order", "references", mode="before")
    @classmethod
