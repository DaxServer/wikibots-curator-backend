...
class QuantityDataValue(BaseModel):
    type: Literal["quantity"] = Field(default="quantity", frozen=True)
    value: DataValueQuantity = Field(description="""Data value quantity""")
